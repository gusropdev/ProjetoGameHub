...
public interface IGameRepository
{
    ...
    Task<List<Game>> GetByGenreAsync(int genreId, CancellationToken cancellationToken = default);
    Task<List<Game>> GetByPlatformAsync(int platformId, CancellationToken cancellationToken = default);
